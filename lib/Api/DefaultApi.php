...
class DefaultApi
{
     ...
     * Add new node
     *
     * @param  int $type Type ID  144 document type (required)
     * @param  int $parent_id ID of parent node (required)
     * @param  string $name Name of the new node (required)
     * @param  \SplFileObject $file The file for the document (specified in the form) (required)
     * @param  string $description Description of the node (optional)
     * @param  bool $advanced_versioning Allow advanced versioning (standard versioning by default) (optional)
     * @param  \DateTime $external_create_date External create date (optional)
     * @param  \DateTime $external_modify_date External modify date (optional)
     * @param  string $external_source External source (optional)
     * @param  string $external_identity External identity (optional)
     * @param  string $external_identity_type External identity type (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\V2ResponseElementPost
     */
    public function addNode($type, $parent_id, $name, $file, $description = null, $advanced_versioning = null, $external_create_date = null, $external_modify_date = null, $external_source = null, $external_identity = null, $external_identity_type = null)
    {
        list($response) = $this->addNodeWithHttpInfo($type, $parent_id, $name, $file, $description, $advanced_versioning, $external_create_date, $external_modify_date, $external_source, $external_identity, $external_identity_type);
        return $response;
    }
     ...
     */
    public function addNodeWithHttpInfo($type, $parent_id, $name, $file, $description = null, $advanced_versioning = null, $external_create_date = null, $external_modify_date = null, $external_source = null, $external_identity = null, $external_identity_type = null)
    {
        $returnType = '\Swagger\Client\Model\V2ResponseElementPost';
        $request = $this->addNodeRequest($type, $parent_id, $name, $file, $description, $advanced_versioning, $external_create_date, $external_modify_date, $external_source, $external_identity, $external_identity_type);
     ...
     */
    public function addNodeAsync($type, $parent_id, $name, $file, $description = null, $advanced_versioning = null, $external_create_date = null, $external_modify_date = null, $external_source = null, $external_identity = null, $external_identity_type = null)
    {
        return $this->addNodeAsyncWithHttpInfo($type, $parent_id, $name, $file, $description, $advanced_versioning, $external_create_date, $external_modify_date, $external_source, $external_identity, $external_identity_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function addNodeAsyncWithHttpInfo($type, $parent_id, $name, $file, $description = null, $advanced_versioning = null, $external_create_date = null, $external_modify_date = null, $external_source = null, $external_identity = null, $external_identity_type = null)
    {
        $returnType = '\Swagger\Client\Model\V2ResponseElementPost';
        $request = $this->addNodeRequest($type, $parent_id, $name, $file, $description, $advanced_versioning, $external_create_date, $external_modify_date, $external_source, $external_identity, $external_identity_type);
     ...
     */
    protected function addNodeRequest($type, $parent_id, $name, $file, $description = null, $advanced_versioning = null, $external_create_date = null, $external_modify_date = null, $external_source = null, $external_identity = null, $external_identity_type = null)
    {
        // verify the required parameter 'type' is set
        if ($type === null || (is_array($type) && count($type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $type when calling addNode'
            );
        }
        // verify the required parameter 'parent_id' is set
        if ($parent_id === null || (is_array($parent_id) && count($parent_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $parent_id when calling addNode'
            );
        }
        // verify the required parameter 'name' is set
        if ($name === null || (is_array($name) && count($name) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $name when calling addNode'
            );
        }
        // verify the required parameter 'file' is set
        if ($file === null || (is_array($file) && count($file) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $file when calling addNode'
            );
        }
